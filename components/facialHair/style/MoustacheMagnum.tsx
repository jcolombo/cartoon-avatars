...
import FacialHairColorComponent from '../FacialHairColorComponent'

interface Props {
  color:FacialHairColorOptions
}

export default class MoustacheMagnum extends React.Component<Props> {
    ...
    return (
      ...
      >
        ...
        <use
          ...
          xlinkHref={'#' + path1}
        />
        <FacialHairColorComponent maskID={mask1} color={this.props.color} />
      </g>
    )
  }
}
