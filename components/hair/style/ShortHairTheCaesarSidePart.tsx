...
import { HairColorOptions, HatColorOptions } from '../../../config'
import { AvatarConfigurationFacialHair } from '../../../index'
import HairColorComponent from '../HairColorComponent'
import FacialHairComponent from '../../FacialHairComponent'
...
export default class ShortHairTheCaesarSidePart extends React.Component<Props> {
      ...
      <g id="Top" strokeWidth="1" fillRule="evenodd">
        ...
        <g id="Top/Short-Hair/The-Caesar-+-Side-Part" mask={`url(#${mask1})`}>
          <g transform="translate(-1.000000, 0.000000)">
            <FacialHairComponent facialHair={this.props.facialHair} />
            <g
              id="Hair"
              strokeWidth="1"
              fillRule="evenodd"
            ...
            >
              ...
              <HairColorComponent maskID={mask2} color={this.props.hairColor} />
            </g>
            {this.props.children}
          </g>
        </g>
